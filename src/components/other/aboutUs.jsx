    ...
    return ( 
        ...
        <div className='bg-gray-300 '>
            ...
            <div>
                ...
                <p className='m-5 p-2'>   Welcome to Jewellery House Nepal, a prestigious destination for exquisite jewelry in the heart of Nepal. As a leading jeweler, we take pride in our rich heritage, exceptional craftsmanship, and commitment to delivering exceptional pieces that capture the essence of elegance. <br /> <br />
...
At Jewellery House Nepal, we believe that jewelry is not just an accessory; it is an expression of individuality, a celebration of love, and a reflection of one's unique style. We understand that every piece of jewelry carries sentimental value and holds cherished memories, which is why we strive to create designs that evoke emotions and create lasting impressions. <br /> <br />
...
Thank you for choosing Jewellery House Nepal, where every piece tells a story and embodies the essence of timeless beauty.   </p>
            </div>
